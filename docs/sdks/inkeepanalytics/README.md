...
* [postQueryPropertyKeys](#postquerypropertykeys)

## postQueryPropertyKeys
...
import {
  ...
  usePostQueryPropertyKeysMutation
} from "@inkeep/inkeep-analytics/react-query/postQueryPropertyKeys.js";
```
...
| `security`                                                                                                                                                                     | [operations.PostQueryPropertyKeysSecurity](../../models/operations/postquerypropertykeyssecurity.md)                                                                           | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
