...
| `countDistinct`                               | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
...
| `countDistinctId`                             | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctOrganizationId`                 | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctMessageId`                      | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctConversationId`                 | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctCreatedAt`                      | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctProjectId`                      | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctIntegrationId`                  | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctEventType`                      | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctType`                           | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctSearchQuery`                    | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctProperties`                     | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
| `countDistinctUserProperties`                 | *number*                                      | :heavy_minus_sign:                            | N/A                                           |
