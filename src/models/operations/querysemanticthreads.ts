...
export const QuerySemanticThreadsStatus = {
  Ok: "ok",
} as const;
export type QuerySemanticThreadsStatus = ClosedEnum<
  typeof QuerySemanticThreadsStatus
>;
...
export type QuerySemanticThreadsResponseBody = {
  status: QuerySemanticThreadsStatus;
  data: QuerySemanticThreadsData;
};
...
/** @internal */
export const QuerySemanticThreadsStatus$inboundSchema: z.ZodNativeEnum<
  typeof QuerySemanticThreadsStatus
> = z.nativeEnum(QuerySemanticThreadsStatus);

/** @internal */
export const QuerySemanticThreadsStatus$outboundSchema: z.ZodNativeEnum<
  typeof QuerySemanticThreadsStatus
> = QuerySemanticThreadsStatus$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace QuerySemanticThreadsStatus$ {
  /** @deprecated use `QuerySemanticThreadsStatus$inboundSchema` instead. */
  export const inboundSchema = QuerySemanticThreadsStatus$inboundSchema;
  /** @deprecated use `QuerySemanticThreadsStatus$outboundSchema` instead. */
  export const outboundSchema = QuerySemanticThreadsStatus$outboundSchema;
}
...
/** @internal */
export const QuerySemanticThreadsData$inboundSchema: z.ZodType<
...
/** @internal */
export const QuerySemanticThreadsData$outboundSchema: z.ZodType<
  QuerySemanticThreadsData$Outbound,
  z.ZodTypeDef,
  QuerySemanticThreadsData
> = z.object({
  totalCount: z.number(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace QuerySemanticThreadsData$ {
  /** @deprecated use `QuerySemanticThreadsData$inboundSchema` instead. */
  export const inboundSchema = QuerySemanticThreadsData$inboundSchema;
  /** @deprecated use `QuerySemanticThreadsData$outboundSchema` instead. */
  export const outboundSchema = QuerySemanticThreadsData$outboundSchema;
  /** @deprecated use `QuerySemanticThreadsData$Outbound` instead. */
  export type Outbound = QuerySemanticThreadsData$Outbound;
}

export function querySemanticThreadsDataToJSON(
  querySemanticThreadsData: QuerySemanticThreadsData,
): string {
  return JSON.stringify(
    QuerySemanticThreadsData$outboundSchema.parse(querySemanticThreadsData),
  );
}

export function querySemanticThreadsDataFromJSON(
  jsonString: string,
): SafeParseResult<QuerySemanticThreadsData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => QuerySemanticThreadsData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'QuerySemanticThreadsData' from JSON`,
  );
}
...
export const QuerySemanticThreadsResponseBody$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  status: QuerySemanticThreadsStatus$inboundSchema,
  data: z.lazy(() => QuerySemanticThreadsData$inboundSchema),
});

/** @internal */
export type QuerySemanticThreadsResponseBody$Outbound = {
  status: string;
  data: QuerySemanticThreadsData$Outbound;
};
...
export const QuerySemanticThreadsResponseBody$outboundSchema: z.ZodType<
  ...
  QuerySemanticThreadsResponseBody
> = z.object({
  status: QuerySemanticThreadsStatus$outboundSchema,
  data: z.lazy(() => QuerySemanticThreadsData$outboundSchema),
});
