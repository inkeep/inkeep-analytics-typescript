 ...
 * Query Conversations
 */
export async function conversationsConversations(
  ...
  Result<
    operations.QueryConversationsResponseBody,
    | errors.BadRequest
    | errors.Unauthorized
    | errors.Forbidden
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.QueryConversationsResponseBody$inboundSchema),
