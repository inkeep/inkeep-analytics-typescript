 ...
 */
export function feedbackDeleteFeedbackById(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteFeedbackByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteFeedbackByIdResponseBody$inboundSchema),
